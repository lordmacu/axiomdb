...
- [ ] ⚠️ 39.13 clustered SQL still lacks executor-visible `SELECT` / `UPDATE` / `DELETE`, and standalone clustered maintenance helpers such as `CREATE INDEX` / `ANALYZE` / `VACUUM` remain deferred — revisit in `39.15` / `39.16` / `39.17` / `39.18`
