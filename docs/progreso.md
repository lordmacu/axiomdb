...
>
> **MySQL+PG parity path: 142/442 subphases (32.1%) — Phase 11 active**
>
...
2. **Fase 11 JSON** — 3 follow-ups restantes (`11.21h`, `11.23c`, `11.24c`).
...
- [ ] 11.25 ⏳ JSON SRF + aggregates + construction helpers (PG paridad "streaming") — cerrar la brecha: tras completar 11.21h falta el *unnesting/construction* idiomatico de PG usado en producciones reales (`jsonb_each`, `jsonb_agg`, `jsonb_build_object`, etc.). Split:
