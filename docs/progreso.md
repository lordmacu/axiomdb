...
- [ ] ⚠️ 39.13 standalone clustered maintenance helpers such as `CREATE INDEX` / `ANALYZE` / `VACUUM` remain deferred — revisit in `39.18`
...
- [ ] ⚠️ 39.17 FK enforcement still rejects clustered child tables, and clustered delete remains logical delete-mark only until purge/VACUUM — revisit in later clustered FK work / `39.18`
