...
- [ ] 40.12 ⏳ Integration Tests & Benchmarks — concurrent INSERT/UPDATE/DELETE/SELECT stress tests; deadlock scenario tests; throughput benchmarks with 1/4/8/16 threads; spec: `specs/fase-40/spec-40.12-integration-tests.md`
