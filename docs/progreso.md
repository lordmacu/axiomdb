...
- [ ] ⚠️ 39.13 clustered SQL still lacks executor-visible `DELETE`, and standalone clustered maintenance helpers such as `CREATE INDEX` / `ANALYZE` / `VACUUM` remain deferred — revisit in `39.17` / `39.18`
