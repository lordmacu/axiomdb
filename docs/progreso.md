...
- [ ] 1.1 ⏳ Workspace setup — Cargo.toml, estructura de carpetas, CI básico
- [ ] 1.2 ⏳ Formato de página — `struct Page`, `PageType`, CRC32 checksum, align(64)
- [ ] 1.3 ⏳ MmapStorage — abrir/crear `.db`, `read_page`, `write_page` con mmap
- [ ] 1.4 ⏳ MemoryStorage — implementación en RAM para tests (sin I/O)
- [ ] 1.5 ⏳ Free list — `alloc_page`, `free_page`, bitmap de páginas libres
