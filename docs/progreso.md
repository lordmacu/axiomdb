...
- [ ] 11.23 ⏳ JSON Schema validation — split into sub-phases:
  ...
  - [ ] 11.23e ⏳ Remaining Draft-07 keywords: `patternProperties`, `format` (email/date-time/uuid/ipv4/ipv6/uri/regex), `$ref` internal refs, `dependencies`, `propertyNames`, `if`/`then`/`else`.
