...
- [ ] 40.11 ⏳ Executor Refactoring — wire `ConnectionTxn` + `LockManager` + `LocalPageBatch` into all DML paths; `ExecutionContext` struct; lock-before-modify for UPDATE/DELETE; re-verification after lock wait; spec: `specs/fase-40/spec-40.11-executor-refactoring.md`
