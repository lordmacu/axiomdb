...
- [ ] 40.9 ⏳ FreeList Tier-1 — per-connection `LocalPageBatch` (64 pages/refill from global Mutex<FreeList> already in 40.3); fast alloc in O(1) with zero locks; batch return on commit/rollback; spec: `specs/fase-40/spec-40.9-freelist-thread-safe.md`
