//! Query result types — the unified return value from the NexusDB executor.
//!
...
use nexusdb_types::{DataType, Value};
...
impl ColumnMeta {
    ...
    ///
    /// [`ColumnDef`]: nexusdb_catalog::schema::ColumnDef
    pub fn new(
...
/// The unified return type from the NexusDB executor for any SQL statement.
///
/// Pattern-match on the variant to handle each statement class:
///
/// ```rust
/// # use nexusdb_sql::result::{QueryResult, ColumnMeta};
/// # use nexusdb_types::{DataType, Value};
