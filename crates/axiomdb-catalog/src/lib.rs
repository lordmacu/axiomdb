...
pub use schema::{
    ...
    SortOrder, StatsDef, TableDatabaseDef, TableDef, TableId, DEFAULT_DATABASE_NAME,
};
pub use writer::{
    CatalogWriter, SYSTEM_TABLE_COLUMNS, SYSTEM_TABLE_CONSTRAINTS, SYSTEM_TABLE_DATABASES,
    SYSTEM_TABLE_FOREIGN_KEYS, SYSTEM_TABLE_INDEXES, SYSTEM_TABLE_STATS, SYSTEM_TABLE_TABLES,
