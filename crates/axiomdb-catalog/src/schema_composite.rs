...
impl CompositeTypeDef {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        debug_assert!(self.fields.len() <= u16::MAX as usize, "too many composite fields");
        ...
        let fields_len: usize = self
            ...
            .sum();
        let mut buf =
            Vec::with_capacity(1 + schema.len() + 1 + name.len() + 2 + fields_len);
        ...
        for field in &self.fields {
            ...
            debug_assert!(tn_bytes.len() <= u16::MAX as usize, "field type name too long");
    ...
    pub fn from_bytes(bytes: &[u8]) -> Result<(Self, usize), DbError> {
        ...
        for _ in 0..field_count {
            ...
            fields.push(CompositeField { name: fname, type_name: tname });
        }

        Ok((Self { schema_name, name, fields }, pos))
    }
}
