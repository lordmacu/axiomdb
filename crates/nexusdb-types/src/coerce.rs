...
//! ## Coercion modes
//!
//! [`CoercionMode::Strict`] (NexusDB default) rejects any `Text` value that
...
///
/// Use [`CoercionMode::Strict`] (the NexusDB default) for correct behavior.
/// Use [`CoercionMode::Permissive`] when the session is in MySQL-compat mode
/// (`SET NEXUS_COMPAT = 'mysql'` — Phase 5).
